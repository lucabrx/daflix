...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    <div className="group bg-neutral-50 col-span relative h-[12vw]">
      ...
      ">
        <img onClick={redirectToWatch} src={data.thumbnailUrl} alt="Movie" draggable={false} className="
          ...
          h-[12vw]
        " />
        <div className=" z-10 bg-neutral-400 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md
          ">
